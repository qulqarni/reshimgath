      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-10 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap justify-center md:flex-col items-center md:items-start gap-x-5 gap-y-1.5 sm:gap-0 sm:space-y-2.5 text-xs text-brand-gray">
              ...
              <button onClick={() => onNavigate('/discover')} className="hidden md:block hover:text-brand-plum font-medium transition-colors">
                {t('discover')}
              </button>
              */}
          ...
          <div className="flex flex-col items-center md:items-start space-y-2 sm:space-y-3">
            ...
            <div className="flex flex-col items-center md:items-start space-y-2 text-xs text-brand-charcoal font-medium">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>pk9823425404@gmail.com</span>
              </div>
              <div className="text-center md:text-left leading-relaxed">
                <MapPin className="inline-block w-3.5 h-3.5 sm:w-4 sm:h-4 text-brand-plum mr-1.5 align-text-bottom" />
